...
<div class="glass-section ticket-chat-container">
    <div class="ticket-header">
        ...
        <?php if ($ticket['status'] !== 'Cerrado'): ?>
            <a href="index.php?controlador=ticket&accion=cerrar&id=<?= $ticket['id'] ?>" class="btn btn-danger">
                <i class="fas fa-lock"></i> Marcar como Resuelto
            </a>
        <?php endif; ?>
    </div>
    ...
    <div class="chat-history" style="margin-bottom: 30px; overflow: auto; max-height: 500px; padding: 10px;">
        <?php foreach ($respuestas as $respuesta): ?>
            <?php
                // Determinar si la respuesta es del Admin (rol 'admin') o del usuario
    ...
    <h3><i class="fas fa-reply"></i> Escribir una Respuesta</h3>
    ...
    <?php else: ?>
        <p class="text-center" style="font-weight: bold; color: var(--danger-color);">Este ticket ha sido cerrado.</p>
    <?php endif; ?>
</div>