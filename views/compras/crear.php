    ...
    <div class="xl:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
                    ...
                    <div class="relative z-50" id="combobox-proveedor-compra">
                        ...
                        <ul id="proveedor-list-compra" class="dropdown-list-floating divide-y divide-slate-100 dark:divide-slate-700">
                        </ul>
                    </div>
                </div>
        ...
        <div class="bg-white dark:bg-slate-700/50 rounded-2xl border border-slate-200 dark:border-slate-600 p-5">
            ...
            <div class="relative mb-4">
                ...
                <div id="compra-resultados" class="dropdown-list-floating hidden"></div>
            </div>
